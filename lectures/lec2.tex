...
that can more or less guarantee that a real human who owns that biometric is on the other end.
Biometrics are not so useful for authenticating over a network because they are not particularly secret.
